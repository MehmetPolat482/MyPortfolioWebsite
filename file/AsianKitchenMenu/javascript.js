...
// BUTONLARI ID DEĞERİ VEREREK OLUŞTURUYORUZ
  const createButton = () => {
    let newBtn = `
      <button id="All" class="btn btn-outline-danger btn-item" type="button">
        All
      </button>
      <button id="Korea" class="btn btn-outline-danger btn-item" type="button">
        Korea
      </button>
      <button id="Japan" class="btn btn-outline-danger btn-item" type="button">
        Japan
      </button>
      <button id="China" class="btn btn-outline-danger btn-item" type="button">
        China
      </button>
    `
